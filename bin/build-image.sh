...
# All docker-entrypoint.sh scripts follow the same template, and source this script to 
...
mkdir -p /var/{log,run}/$SERVICE
[[ $(type -t docker_entry_setup) = "function" ]] || exit;
docker_entry_setup  # This function is defined in the entrypoint script
